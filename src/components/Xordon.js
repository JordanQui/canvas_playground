...
export default function Xordon({ id, imgSrc, title }) {
     useEffect(() => {
          ...
          script.onload = () => {
               ...
               const hydra = new Hydra({
                ...
                s0.initImage("/gliss2.png");
                s1.initImage("/trame.png");

                src(s1)
                    .scale(() => 4 - (smoothedValues.valueLo * 15))
                    .modulate(o1,0.1)
                    .out(o1)
                ...
                src(s0)
                     ...
                     .scrollX(0, 0.1)
                     .kaleid(4)
                     .scale(() => smoothedValues.valueLo * 0 + 0.2)
                     .modulate(
                          o0,
                          () =>
                               smoothedValues.valueHi * 0.15
                     )
                     .modulate(o1,() => smoothedValues.valueLo * 10)
                     .contrast(() => 1 + smoothedValues.valueLo * 3 + smoothedValues.valueHi * 10)
                     .out(o0);
          };
